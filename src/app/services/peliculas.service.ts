...
export class PeliculasService {
  ...
  getCartelera(): Observable<Result[]> {
    ...
    this.cargando = true;
    return this.http
      .get<Movies>(`${this.baseUrl}/movie/now_playing`, {
        params: this.params,
      })
      .pipe(
  ...
  buscarPeliculas(texto: string): Observable<Result[]> {
    ...
    return this.http
      .get<Movies>(`${this.baseUrl}/search/movie`, {
        params,
      })
  ...
  getPeliculaDetalle(id: string) {
    return this.http
      .get<DetailsMovie>(`${this.baseUrl}/movie/${id}`, {
        params: this.params,
      })
  ...
  getCredits(id: string) {
    return this.http
      .get<CastResponse>(`${this.baseUrl}/movie/${id}/credits`, {
        params: this.params,
      })
      .pipe(
        map((resp) => resp.cast),
